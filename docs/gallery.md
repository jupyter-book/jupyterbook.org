...
To add your book to this list, [add an entry to this gallery.yml file](https://github.com/jupyter-book/jupyterbook.org/edit/main/docs/gallery.yml) and open a Pull Request.


````{card}
:link: https://mystmd.org/guide
:header: [Myst Official Documentation](https://mystmd.org/guide)
