...
The MyST Document Engine and Markdown syntax is also developed by the [Jupyter Book community](./index.md). Learn more at the [MyST Document Engine documentation](https://mystmd.org). Read the paper at [](#scipy-paper).
